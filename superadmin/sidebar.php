<div class="lecturerSideBar">
            ...
            <div class="lecturerDetails">
                <div class="holdImage"> 
                    <img src="../img/<?php echo $rowsIV['img']?>" alt="superadminImg">
                </div>
                <div class="details">
                    <h3 class="name"><?php echo $rowsIV['lastname']." ".$rowsIV['firstname']." ". $rowsIV['middlename'] ?></h3>
                    <h2 class="matricNo"><?php echo $rowsIV['level']?></h2>
                    <p class="level"><?php echo $rowsIV['pos']?></p>
                </div>
            </div>
                ...
                <div class="section">
                    ...
                    <div class="iconDept dashboard active">
                        <div class="text active">
                            ...
                            <li><a class="active" href="superadmingui.php">Dashboard</a></li>
                        </div>
                    </div>
                </div>
