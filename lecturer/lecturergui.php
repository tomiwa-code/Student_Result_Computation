        ...
        <div class="bodyDetails">
            <div class="mainDetailsContainer">
                <div class="mapDetails">
                    ...
                    <h1>Welcome</h1>
                    <h2><?php echo $rowsII['lastname']." ".$rowsII['firstname']." ". $rowsII['middlename'] ?></h2>
                    <p><?php echo $rowsII['position']?></p>
                </div>
                <div class="desc">
                    <p>Moshood Abiola Polytechnic graciously welcomes you, <?php echo $rowsII['firstname'] ?> to regularly use this uncommon tool in conformity to our desire to be a world-class institution producing the best-breed of pupils of international repute and global champions of tomorrow. Deployments of up-to-now technologies amongst other investments give us the superior edge above other schools. Moshood Abiola Polytechnic is now accessible to you anywhere, anytime, 24/7/366.
                    <br><br>
