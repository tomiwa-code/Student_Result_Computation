...
<body>
    <div class="main-Containers">
        ...
        <div class="bodyDetails">
            ...
            <div class="detailContainer secondSemes">
                ...
                <div class="updateInfo und">
                    <div class="lInfo">
                        <h2 class="nos">No. of students: <span></span></h2>
                        <h2 class="stusubmit">Submitted: <span></span> </h2>
                        <h2 class="stuactive">Active: <span></span></h2>
                    </div>
                    <div class="search">
                        <div class="searchbox">
    ...
    <script src="../js/yeartwo.js"></script>
    ...
    <script>
        $(document).ready(function () {
            ...
            $(".nd2 .iconDept").addClass("active");
            $(".nd2 .text").addClass("active");
            $(".nd2 .s a").addClass("active"); 

            $('.lecturerSideBar').animate({
                scrollTop: $('a[href="ndyeartwosecondsemester.php"]').offset().top
            },1000)
        })
    </script>
</body>
