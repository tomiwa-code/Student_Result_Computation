        ...
        <div class="bodyDetails">
            ...
            <div class="detailContainer secondSemes">
                ...
                <div class="updateInfo">
                    <div class="lInfo">
                        <h2 class="unos">Marks Submitted: <span></span></h2>
                        <h2 class="ustusubmit">Uploaded: <span></span></h2>
                        <h2 class="ustuactive">Active: <span></span></h2>
                    </div>
                    <div class="search">
                        <div class="searchbox">
