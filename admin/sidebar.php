<div class="lecturerSideBar">
            ...
            <div class="lecturerDetails">
                <div class="holdImage">
                    <img src="../img/<?php echo $rowsIII['img']?>" alt="adminImg">
                </div>
                <div class="details">
                    <h3 class="name"><?php echo $rowsIII['lastname']." ".$rowsIII['firstname']." ". $rowsIII['middlename'] ?></h3>
                    <h2 class="matricNo"><?php echo $rowsIII['level']?></h2>
                    <p class="level"><?php echo $rowsIII['pos']?></p>
                </div>
            </div>
                ...
                <div class="section">
                    ...
                    <div class="iconDept dashboard active">
                        <div class="text active">
                            ...
                            <li><a class="active" href="admingui.php">Dashboard</a></li>
                        </div>
                    </div>
                </div>
